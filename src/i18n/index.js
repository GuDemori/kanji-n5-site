...
const messages = {
  'pt-BR': {
    ...
    teForm: {
      title: 'Prática da forma て',
      subtitle: 'Veja o verbo base e treine a forma て, a tradução, ou as duas respostas.',
  ...
  en: {
    ...
    teForm: {
      ...
      subtitle: 'Read the base verb and practice the te form, the translation, or both answers.',
