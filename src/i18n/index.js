...
const messages = {
  'pt-BR': {
    ...
    teForm: {
      ...
      subtitle: 'Treine conjugações, tradução, ou inverta para responder o verbo em japonês.',
      conjugationTypeLabel: 'Tipo de prática',
      conjugationTypeTe: 'Forma て',
      conjugationTypeNai: 'Forma ない',
      invertPractice: 'Inverter tradução',
      answerTeForm: 'Responder forma て',
      answerNaiForm: 'Responder forma ない',
      answerTranslation: 'Responder tradução',
      promptLabel: 'Verbo base',
      translationPromptLabel: 'Tradução',
      teFormLabel: 'Forma て',
      naiFormLabel: 'Forma ない',
      translationLabel: 'Tradução',
      baseVerbLabel: 'Verbo em japonês',
      teFormPlaceholder: 'Digite a forma て',
      naiFormPlaceholder: 'Digite a forma ない',
      translationPlaceholder: 'Digite a tradução',
      baseVerbPlaceholder: 'Digite o verbo base em japonês',
      check: 'Verificar',
      next: 'Próximo verbo',
      rulesTitle: 'Regras da forma て',
      teRulesTitle: 'Regras da forma て',
      naiRulesTitle: 'Regras da forma ない',
      ruleLabel: 'Regra',
      examplesLabel: 'Exemplos',
      exceptionLabel: 'Exceção',
      attentionLabel: 'Atenção',
      structureLabel: 'Estrutura',
      phraseLabel: 'Exemplo',
      meaningLabel: 'Sentido',
      groupGuideTitle: 'Antes de conjugar',
      groupGuideIntro: 'Identifique o grupo pelo verbo base.',
      groupGuide: {
        group1: 'Som antes de ます muda na conjugação: かきます, よみます, とります, はなします.',
        group2: 'Normalmente som de え antes de ます; alguns em い são memorizados: たべます, みます, おきます.',
        group3: 'Irregulares: します, きます e compostos como べんきょうします, もってきます.',
      },
      usesTitle: 'Usos da forma て',
      teUsesTitle: 'Usos da forma て',
      naiUsesTitle: 'Usos da forma ない',
      ...
      feedback: {
        ...
        wrong: 'Ainda não.\n{conjugationLabel} correta: {conjugation}\nTradução correta: {translation}',
      ...
      rules: {
        ...
        exception: 'Exceção:',
        nai: {
          group1Description: 'Troca o som antes de ます para a coluna あ e adiciona ない.',
          group1IException: 'Atenção para verbos terminados em います: troca para わない.',
          group2Description: 'Remove ます e adiciona ない.',
          group3Irregular: 'Verbos irregulares:',
          group3SuruCompound: 'Verbos compostos com します:',
          group3KuruCompound: 'Verbo composto com きます:',
        },
      },
      ...
      naiUses: '1. Pedido negativo / proibição educada:\nV forma ない + でください\nしゃしんを とらないでください。\nPor favor, não tire fotos.|2. Obrigação:\nV forma ない sem い + ければなりません\nのまない -> のまなければなりません\nくすりを のまなければなりません。\nTenho que tomar remédio.|3. Não é necessário fazer:\nV forma ない sem い + くてもいいです\nこない -> こなくてもいいです\nあした こなくてもいいです。\nNão precisa vir amanhã.',
    },
    store: {
  ...
  en: {
    ...
    teForm: {
      ...
      groupGuideTitle: 'Before conjugating',
      groupGuideIntro: 'Identify the group from the base verb.',
      groupGuide: {
        group1: 'Sound before ます changes when conjugated: かきます, よみます, とります, はなします.',
        group2: 'Usually an え sound before ます; some い verbs are memorized: たべます, みます, おきます.',
        group3: 'Irregulars: します, きます, and compounds like べんきょうします, もってきます.',
      },
      usesTitle: 'Uses of the te form',
      teUsesTitle: 'Uses of the te form',
      naiUsesTitle: 'Uses of the nai form',
      ...
      feedback: {
        ...
        wrong: 'Not yet.\nCorrect {conjugationLabel}: {conjugation}\nCorrect translation: {translation}',
      ...
      rules: {
        ...
        exception: 'Exception:',
        nai: {
          group1Description: 'Change the sound before ます to the あ column and add ない.',
          group1IException: 'Watch verbs ending in います: change to わない.',
          group2Description: 'Remove ます and add ない.',
          group3Irregular: 'Irregular verbs:',
          group3SuruCompound: 'Compound verbs with します:',
          group3KuruCompound: 'Compound verb with きます:',
        },
      },
      ...
      naiUses: '1. Negative request / polite prohibition:\nV nai form + でください\nしゃしんを とらないでください。\nPlease do not take photos.|2. Obligation:\nV nai form without い + ければなりません\nのまない -> のまなければなりません\nくすりを のまなければなりません。\nI have to take medicine.|3. Not necessary to do:\nV nai form without い + くてもいいです\nこない -> こなくてもいいです\nあした こなくてもいいです。\nYou do not need to come tomorrow.',
    },
    store: {
